...
namespace WindowsFormsApplication1
{
    public partial class Form5 : Form
    {
        ...
        private void b3_Click(object sender, EventArgs e)
        {
            ...
            string muracattarih = dateTimePicker3.Text;
            conn.Open();
            OleDbCommand cmd = new OleDbCommand("UPDATE Durusma SET d_tarih='" + durusmatarih + "',d_saat='" + maskedTextBox2.Text + "',kesif_tarih='" + kesiftarih + "',mehilsuresi='" + textBox1.Text + "',muracat_tarih='" + muracattarih + "'WHERE d_no='" + textBox2.Text + "'", conn);
            cmd.ExecuteNonQuery();
